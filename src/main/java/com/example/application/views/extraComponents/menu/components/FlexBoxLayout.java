package com.example.application.views.extraComponents.menu.components;

import com.example.application.views.extraComponents.menu.size.Size;
...
public class FlexBoxLayout extends FlexLayout {
    ...
    public void setBorderRadius(BorderRadiusGen radius) {
    ...
    public void setBoxSizing(BoxSizingGen sizing) {
    ...
    public void setDisplay(DisplayGen display) {
    ...
    public void setFlexDirection(FlexDirectionGen direction) {
    ...
    public void setFlexWrap(FlexWrapGen wrap) {
