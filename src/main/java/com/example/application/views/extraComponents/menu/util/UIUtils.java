package com.example.application.views.extraComponents.menu.util;
...
public class UIUtils {
    ...
    public static void setBorderRadius(BorderRadiusGen borderRadius,
                                       Component... components) {
        for (Component component : components) {
    ...
    public static void setBoxSizing(BoxSizingGen boxSizing,
                                    Component... components) {
        for (Component component : components) {
    ...
    public static void setDisplay(DisplayGen display, Component... components) {
        for (Component component : components) {
    ...
    public static void setFlexWrap(FlexWrapGen flexWrap, Component... components) {
        for (Component component : components) {
